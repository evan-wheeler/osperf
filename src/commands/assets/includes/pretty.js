...
},{"./lib/lexer":4,"./lib/parser":6,"./lib/preprocessor":7,"./lib/walk":8,"./lib/walker":9}],2:[function(require,module,exports){
...
},{"./language_features":3,"./lexer":4,"./preprocessor":7,"lodash":10}],7:[function(require,module,exports){
// preproccessor.js
...
LineFormatter.prototype.expandTabs = function(val, offset) {
    ...
    return val
        ...
        .map(function(v, i, a) {
            var t =
                v + (i + 1 >= a.length ? "" : ["    ", "   ", "  ", " "][(offset + v.length) % 4]);
            offset = 0;
            return t;
        })
        .join("");
...
Pretty.prototype.format = function() {
            ...
            if (node.callee) {
                ...
                if (callee.type === "MemberExpression") {
                    ...
                    setTokenProp(
                        callee,
                        "extra",
                        { type: "FunctionCall", annotated: annotated },
                        true
                    );
                }
            }
    ...
    for (i = 0; i < len; ++i) {
        ...
        annotate = annotatedLines[lineNum] ? "annotated" : "";
        var tok = allTokens[i];
